# 17. API Reference (Draft)

> 中文版：[../../reference/17_api_reference.md](../../reference/17_api_reference.md)

This is not the final implementation, just a reference interface for developers to understand the protocol.
